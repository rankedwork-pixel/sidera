...
## Model Pricing (Anthropic, as of early 2025)

| Model | Input (per 1M tokens) | Output (per 1M tokens) | Typical Use |
|-------|----------------------|----------------------|-------------|
| Haiku | $0.25 | $1.25 | Data collection, routing, memory extraction |
...
Estimated conversational usage: ~10 conversations/day × 5 turns avg × $0.08/turn = **$4.00/day**
...
### Scenario A: Marketing Department Only (Current Setup)
...
Using a cheaper OpenAI-compatible provider (Groq, Together AI) for routing, extraction, and reflection tasks. Estimated 55-60% cost reduction on Haiku-tier tasks:

| Scenario | Without Hybrid | With Hybrid | Savings |
|----------|---------------|-------------|---------|
| A (Current) | $2,885 | $2,650 | $235 (8%) |
| C (15 Roles) | $5,656 | $4,800 | $856 (15%) |
...
|---|---|---|
| **Annual cost** | ~$2,900 | ~$350,000+ (media buyer + analyst + strategist salaries) |
